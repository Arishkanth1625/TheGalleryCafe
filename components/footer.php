...
<footer class="footer">
    <section class="grid">
        ...
        <div class="links">
            ...
            <a href="mailto:theoutercloverestaurant@gmail.com"><i class="fas fa-envelope"></i>thegallerycaferestaurant@gmail.com</a>
    ...
    <div class="credit">Created and Designed by <span></span> | &copy all rights 
    reserved!</div>
</footer>