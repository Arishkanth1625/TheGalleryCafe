...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <?php
            $select_event = $conn->prepare("SELECT * FROM events_promotions");
            $select_event->execute();
            $numbers_of_event = $select_event->rowCount();
         ?>
         <h3><?= $numbers_of_event; ?></h3>
         <p>Event</p>
         <a href="AddEvent.php" class="btn">see event</a>
      </div>
